	...
	<div class="container">
		<section class="choose_section">
			...
			<div class="col-md-4">
				<div class="choose_blk">
					<div class="choose_img">
						<img src="<?= get_site_url(); ?>/wp-content/themes/hestia/assets/img/secure.png" alt="">
					</div>
			...
			<div class="col-md-4">
				<div class="choose_blk">
					<div class="choose_img">
						<img src="<?= get_site_url(); ?>/wp-content/themes/hestia/assets/img/fast-deliver.png" alt="">
					</div>
					<div class="choose_content">
						<h4>SECURED SERVICES</h4>
						<p>Aliquam etiam porttitor vehicula leo, tortor maecenas. Morbi vulputate in dui sit. Eget purus sit fringilla viverra in.</p>
			...
			<div class="col-md-4">
				<div class="choose_blk">
					<div class="choose_img">
						<img src="<?= get_site_url(); ?>/wp-content/themes/hestia/assets/img/support.png" alt="">
					</div>
					<div class="choose_content">
						<h4>SECURED SERVICES</h4>
						<p>Aliquam etiam porttitor vehicula leo, tortor maecenas. Morbi vulputate in dui sit. Eget purus sit fringilla viverra in.</p>
...
<style>
	...
	.our_services {
		background: url(http://localhost:88/sevenstarsshipping.com/wp-content/uploads/2022/08/service.jpg) no-repeat center center;
	}
